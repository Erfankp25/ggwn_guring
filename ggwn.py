...
label_mapping = {
    ...
    "Quality of Sleep": "Kualitas Tidur (1-10)",
    ...
    if st.button("🔍 Prediksi"):
        ...
        saran = {
            ...
            **💡 Solusi untuk {nama_pengguna} (Sleep Apnea):**
            ...
            4. Tidur menyamping, bukan telentang.
...
def about():
    ...
    st.write("Aplikasi ini dibuat menggunakan model ensemble (Random Forest + XGBoost) untuk memprediksi gangguan tidur berdasarkan data gaya hidup dan kesehatan.")
